...
if(empty($pagina)){
    require_once __DIR__ . '/../src/CandidoSouza/Applications/pages/listaClientes.php';
}elseif($pagina == 'visualizarCliente'){
    require_once __DIR__ . '/../src/CandidoSouza/Applications/pages/visualizarCliente.php';
}elseif(isset($pagina ) && in_array($pagina,$permission)!= $permission){
    require_once __DIR__ . '/../src/CandidoSouza/Applications/pages/404.php';
}else{
    require_once __DIR__ . '/../src/CandidoSouza/Applications/pages/listaClientes.php';
}
